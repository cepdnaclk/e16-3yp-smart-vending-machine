...
try :
    ...
    response = requests.post('http://ec2-54-87-72-111.compute-1.amazonaws.com/api/api/token/', json=load)
...
# print(header)
url='http://ec2-54-87-72-111.compute-1.amazonaws.com/api/orders/'+qrData['Id']+'/'
